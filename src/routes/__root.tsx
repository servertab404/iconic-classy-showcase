...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Iconic Classy — BCA AI/ML Student" },
      { name: "description", content: "Portfolio of Iconic Classy, aspiring ML engineer." },
      { name: "author", content: "Iconic Classy" },
  ...
  return (
    <QueryClientProvider client={queryClient}>
      ...
      <Toaster
        ...
        toastOptions={{
          style: {
            background: "oklch(0.185 0.04 288)",
